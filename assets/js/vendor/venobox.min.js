! function(e, t) {
    ...
    function _(e) {
        if (!e) return !1;
        y = !0, r = e, h = !1, w = !1, S = e.getAttribute("data-maxwidth") || e.settings.maxWidth, C = e.getAttribute("data-overlay") || e.settings.overlayColor, E = e.getAttribute("data-ratio") || e.settings.ratio, q = e.getAttribute("data-autoplay") || e.settings.autoplay, M = e.getAttribute("data-href") || e.getAttribute("href"), P = e.getAttribute(e.settings.titleattr) || ""
    }

    function G() {
        return !(!r || !document.body.classList.contains("vbox-open")) && ((!r.settings.onPreClose || "function" != typeof r.settings.onPreClose || (r.settings.onPreClose(r, p, j, H), !1 !== r.settings.onPreClose)) && (document.body.removeEventListener("keydown", te), document.body.classList.remove("vbox-open"), r.focus(), void U({
            duration: 200,
            timing: K,
            draw: function(e) {
    ...
    function te(e) {
        27 === e.keyCode && G(), O || (37 == e.keyCode && !0 === w && ve(H), 39 == e.keyCode && !0 === h && ve(j), O = setTimeout(() => {
            O = null
        }, 100))
    }
    ...
    function oe(e) {
        a.classList.contains("vbox-" + e) || function() {
            ...
            e.classList.add("vbox-child"), e.style.padding = r.settings.border, e.style.backgroundColor = r.settings.bgcolor, e.style.maxWidth = S, e.style.transform = "scale(0.9)", e.style.transition = "transform 200ms";
            let t = a.querySelector(".vbox-child img");
            t && t.addEventListener("dragstart", function(e) {
                e.preventDefault()
            }), i.scrollTo(0, 0), e.style.transform = "scale(1)", U({
                duration: 200,
                timing: K,
                draw: function(e) {
    ...
    function ne(e, t, o) {
        let n;
        if (a.classList.add("vbox-loading"), -1 !== e.search(/.+\.mp4|og[gv]|webm/)) x = '<div class="venoratio venoratio-' + t + '"><video src="' + e + '"' + (n = o ? " autoplay" : "") + " controls>Your browser does not support the video tag.</video></div>";
        else {
            let s, i = function(e) {
                    let t;
                ...
                a = (n = o ? "?rel=0&autoplay=1" : "?rel=0") + function(e) {
                    let t = "",
                        o = decodeURIComponent(e).split("?");
                    if (void 0 !== o[1]) {
                        let e, n, s = o[1].split("&");
                        for (n = 0; n < s.length; n++) t = t + "&" + (e = s[n].split("="))[0] + "=" + e[1]
                    }
                    return encodeURI(t)
                }(e);
        ...
        if (e = x, R.innerHTML = e, (g = R.querySelectorAll("img")).length) {
            ...
            F(g, function(t) {
                ...
                (X = new Image).onload = function() {
                    ++e == g.length && (a.classList.remove("vbox-loading"), oe("animated"))
                }, X.onerror = function() {
                    ++e == g.length && (a.classList.remove("vbox-loading"), oe("animated"))
                }, X.src = o
            })
    ...
    function ie(e) {
        if (!y) {
            ...
            a.style.transition = "margin " + t + "ms ease-out, opacity " + t + "ms ease-out", A = v = e.pageY, D = Q = e.pageX, W = !0
        }
    }
    ...
    function ae(e) {
        if (W) {
            ...
            let e = r,
                t = !1;
            (N = Q - D) < 0 && h && (e = j, t = !0), N > 0 && w && (e = H, t = !0), Math.abs(N) >= Z && t ? ve(e) : (a.style.marginLeft = 0, a.style.opacity = 1)
        }
    }
    ...
    function le(e) {
        if (!e) return !1;
        T = e.dataset.gall, L = e.settings.numeration, f = e.settings.infinigall, o.innerHTML = "";
        ...
        e.settings.share && "iframe" !== s && "inline" !== s && "ajax" !== s && function(e) {
            if (navigator.canShare) {
                ...
                o.insertAdjacentHTML("beforeend", '<div class="vbox-link-btn vbox-share-mobile">' + I + "</div>"), o.querySelector(".vbox-share-mobile").addEventListener("click", function(e) {
                    e.preventDefault(), navigator.share(t)
                })
            }
            o.insertAdjacentHTML("beforeend", '<a target="_blank" href="' + e + '" download>' + B + "</a>"), o.insertAdjacentHTML("beforeend", '<div class="vbox-tooltip"><div class="vbox-link-btn vbox-share-copy"><span class="vbox-tooltip-text" id="myTooltip"></span>' + V + "</div ></div>"), o.querySelector(".vbox-share-copy").addEventListener("click", function(t) {
                t.preventDefault();
        ...
        }(e.href), m = document.querySelectorAll('.vbox-item[data-gall="' + T + '"]'), l = Array.prototype.indexOf.call(m, e), m.length < 2 && (f = !1, L = !1), j = m[l + 1], H = m[l - 1], !j && f && (j = m[0]), !H && f && (H = m[m.length - 1]), m.length >= 1 ? (p = l + 1, t.innerHTML = p + " / " + m.length) : p = 1, L ? t.classList.remove("vbox-hidden") : t.classList.add("vbox-hidden"), "" !== P ? n.classList.remove("vbox-hidden") : n.classList.add("vbox-hidden"), n.innerHTML = P, w = !1, h = !1, (j || f) && (h = !0), (l > 0 || f) && (w = !0), (w || h) && e.settings.navTouch ? (a.classList.add("vbox-grab"), a.addEventListener("touchstart", ie, !1), a.addEventListener("touchend", ae, !1), a.addEventListener("touchmove", re, !1), a.addEventListener("mousedown", ie, !1), a.addEventListener("mouseup", ae, !1), a.addEventListener("mouseout", ae, !1), a.addEventListener("mousemove", re, !1)) : (a.classList.remove("vbox-grab"), a.removeEventListener("touchstart", ie, !1), a.removeEventListener("touchend", ae, !1), a.removeEventListener("touchmove", re, !1), a.removeEventListener("mousedown", ie, !1), a.removeEventListener("mouseup", ae, !1), a.removeEventListener("mouseout", ae, !1), a.removeEventListener("mousemove", re, !1));
        let i = k.querySelector(".vbox-next"),
            r = k.querySelector(".vbox-prev");
        w ? r.classList.remove("vbox-hidden") : r.classList.add("vbox-hidden"), h ? i.classList.remove("vbox-hidden") : i.classList.add("vbox-hidden"), e.settings.navigation || (i.classList.add("vbox-hidden"), r.classList.add("vbox-hidden"))
    }
    ...
    function de(t) {
        e.style.backgroundColor = C, b.innerHTML = function(e) {
            ...
            return t += "</div>"
        }(Y[t.settings.spinner]), k.style.setProperty("--sk-color", t.settings.spinColor), u.classList.remove("vbox-hidden"), o.classList.remove("vbox-top", "vbox-bottom"), n.classList.remove("vbox-top", "vbox-bottom"), "top" == t.settings.titlePosition ? (n.classList.add("vbox-top"), o.classList.add("vbox-bottom")) : (n.classList.add("vbox-bottom"), o.classList.add("vbox-top"));
    ...
    function ce() {
        ...
        switch (r.dataset.vbtype) {
            case "iframe":
                e = M, t = E, a.classList.add("vbox-loading"), x = '<div class="venoratio venoratio-' + t + '"><iframe src="' + e + '"></iframe></div>', a.classList.remove("vbox-loading"), oe("animated");
                break;
            case "inline":
                ! function(e) {
                    let t = document.querySelector(e);
                    t && (a.classList.add("vbox-loading"), x = '<div class="vbox-inline">' + t.innerHTML + "</div>", a.classList.remove("vbox-loading"), oe("animated"))
                }(M);
                break;
            case "ajax":
                ! function(e) {
                    ...
                    t.open("GET", e, !0), t.onload = function() {
                        ...
                        x = '<div class="vbox-inline"></div>', a.classList.remove("vbox-loading"), oe("animated")
                    }, t.send()
                }(M);
                break;
            case "video":
            ...
            default:
                ! function(e) {
                    X.onload = function() {
                        x = '<div class="vbox-child"><img src="' + e + '"></div>', a.classList.remove("vbox-loading"), oe("animated")
                    }, X.src = e
                }(M)
        }
        var e, t
    ...
    function ve(e) {
        ...
        a.classList.add("vbox-animated", "vbox-loading"), le(e), U({
            duration: r.settings.navSpeed,
            timing: K,
            draw: function(e) {
                a.style.opacity = o - e / o, 1 === e && (a.classList.remove("swipe-left", "swipe-right", "vbox-animated"), a.style.marginLeft = 0, a.style.transition = "", oe("loading"), y = !1, r.settings.onNavComplete && "function" == typeof r.settings.onNavComplete && r.settings.onNavComplete(r, p, j, H))
            }
        }), ce()
    }
    ...
    function ue(l) {
        return !(document.body.classList.contains("vbox-open") || !l) && (l.settings.onPreOpen && "function" == typeof l.settings.onPreOpen && l.settings.onPreOpen(l), !!l.settings.onPreOpen && (_(l), document.body.insertAdjacentHTML("beforeend", s), document.body.classList.add("vbox-open"), k = document.querySelector(".vbox-overlay"), e = k.querySelector(".vbox-backdrop"), i = k.querySelector(".vbox-container"), a = i.querySelector(".vbox-content"), t = k.querySelector(".vbox-num"), o = k.querySelector(".vbox-share"), n = k.querySelector(".vbox-title"), u = k.querySelector(".vbox-preloader"), b = u.querySelector(".vbox-preloader-inner"), k.style.opacity = 0, de(l), le(l), a.classList.add("vbox-animated", "vbox-loading"), U({
            ...
            timing: K,
            draw: function(e) {
                k.style.opacity = e, 1 === e && (a.classList.remove("vbox-animated"), y = !1, oe("loading"), r.settings.onPostOpen && "function" == typeof r.settings.onPostOpen && r.settings.onPostOpen(r, p, j, H))
            }
        }), ce(), l.settings.navKeyboard && (document.body.addEventListener("keydown", te), document.body.addEventListener("keyup", () => {
